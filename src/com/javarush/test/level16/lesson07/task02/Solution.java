...
public class Solution {
    ...
    public static class Stopwatch extends Thread {
        ...
        private void doSeveralSteps() throws InterruptedException {
            ...
            System.out.println(this.owner.getName() + "> " + Thread.currentThread().getState());

            Thread.currentThread().interrupt();

            if(Thread.currentThread().isInterrupted())
                System.out.println(this.owner.getName() + "> interrupted, yes " + Thread.currentThread().getState());
            else
                System.out.println(this.owner.getName() + "> interrupted, no " + Thread.currentThread().getState());
